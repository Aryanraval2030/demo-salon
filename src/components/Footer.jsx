      ...
      <div className={`container ${styles.top}`}>
        <div className={styles.brandCol}>
          ...
          <p className={styles.tagline}>
            Premium hair, bridal makeup, nails, and skin care in the heart of Ahmedabad.
          </p>
          <div className={styles.socials}>
            <a href="#" aria-label="Saura Salon on Instagram" className={styles.socialIcon}>
              <InstagramIcon />
            </a>
            <a href="#" aria-label="Saura Salon on Facebook" className={styles.socialIcon}>
              <FacebookIcon />
            </a>
          </div>
        </div>
        ...
        <div className={styles.col}>
          ...
          <ul className={styles.contactList}>
            <li>
              ...
              <span>Beside Trupti Bakery, Opp. Planet Health, Jodhpur Village, Ahmedabad.</span>
            </li>
            <li>
